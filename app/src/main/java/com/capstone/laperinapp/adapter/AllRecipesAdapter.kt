...
class AllRecipesAdapter: PagingDataAdapter<DataItemRecipes, AllRecipesAdapter.ViewHolder>(DIFF_CALLBACK) {
    ...
    interface OnItemClickCallback {
        fun onItemClicked(data: DataItemRecipes, holder: ViewHolder)
    }
